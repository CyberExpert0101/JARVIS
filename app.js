...
function speakThis(message) {
    ...
    if(message.includes('hey') || message.includes('hello')) {
        ...
        const finalText = "I'm Jarvis";
        speech.text = finalText;
    }


    else if(message.includes('who is made you')) {
        const finalText = "Goutam is my developer";
        speech.text = finalText;
    }
    ...
    else if(message.includes('what is your developers name')) {
        const finalText = "my developers name is Goutam";
        speech.text = finalText;
    }
